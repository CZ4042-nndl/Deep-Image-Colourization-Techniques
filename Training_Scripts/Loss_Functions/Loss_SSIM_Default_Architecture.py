...
class Configuration:
    checkpoint_file_name = 'loss_SSIM_checkpoint'  # The number will follow and then the .pt
    load_model_file_name = 'loss_SSIM_checkpoint18.pt'
    starting_epoch = 1 # + 13
...
# def StructuralSimilarityIndex_Loss(preds, target):
#     return 1 - ssim(preds, target)
loss_criterion = lambda preds, target: 1 - ssim(preds, target)  # Created because SSIM increases upto 1 with increasing similarity
